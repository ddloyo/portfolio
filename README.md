...
Calidad, consolidación y confiabilidad de los datos — la base antes de analizar.
...
Diagnóstico y visibilidad: qué está pasando y por qué, listo para decidir.
...
Modelos predictivos y de optimización — de qué pasó a qué va a pasar.
...
El mismo patrón aplica a cualquiera de los 13 proyectos.
...
- Los 13 dashboards comparten una sola librería de estilo (`_lib/`) con una paleta validada para accesibilidad (contraste y distinción para daltonismo), para que el portafolio se sienta como un solo producto, no como 13 experimentos sueltos.
