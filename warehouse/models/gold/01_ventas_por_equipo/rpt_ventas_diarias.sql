-- Dashboard 01 · projects/01-sales-performance-dashboard/data/ventas_diarias.csv
-- Grano: 1 fila por fecha x equipo x vendedor x línea de producto. Solo ventas del
-- canal gestionado con vendedor asignado (las de autoservicio no son de ningún equipo).
select
